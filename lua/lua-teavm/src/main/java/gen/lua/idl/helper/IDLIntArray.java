...
public class IDLIntArray extends IDLArray {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new lua.IDLIntArray(size);
      return lua.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new lua.IDLIntArray(size);return lua.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = lua.wrapPointer(this_addr, lua.IDLIntArray);
      lua.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = lua.wrapPointer(this_addr, lua.IDLIntArray);lua.destroy(jsObj);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = lua.wrapPointer(this_addr, lua.IDLIntArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = lua.wrapPointer(this_addr, lua.IDLIntArray);jsObj.setValue(index, value);")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = lua.wrapPointer(this_addr, lua.IDLIntArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
