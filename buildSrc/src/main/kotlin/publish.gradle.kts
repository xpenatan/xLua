        ...
        publications.configureEach {
            if (this is MavenPublication) {
                pom {
                    ...
                    scm {
                        connection.set("scm:git:git://https://github.com/xpenatan/xLua.git")
                        developerConnection.set("scm:git:ssh://https://github.com/xpenatan/xLua.git")
                        url.set("http://https://github.com/xpenatan/xLua/tree/master")
                    }
                    licenses {
                        license {
